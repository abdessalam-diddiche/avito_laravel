...
<div class="card d-flex justify-content-around" style="width:60rem; margin:50px auto;">
  ...
  <img src="{{ asset('storage/'.$announce->image1) }}" width="40%" heigth="70px" style="margin:15px">
  <img src="{{ asset('storage/'.$announce->image2) }}" width="40%" heigth="70px" style="margin:15px">
